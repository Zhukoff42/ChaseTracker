...
local render_update_window = imgui.OnFrame(function() return update_available end, function(player)
    ...
    if imgui.Begin(u8"Доступно обновление ChaseTracker", imgui.new.bool(true), bit.bor(imgui.WindowFlags.NoCollapse, imgui.WindowFlags.NoResize, imgui.WindowFlags.NoSavedSettings)) then
